...
import com.example.android.expencemanager.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements OnItemsClick{
    ...
    Intent intent;
    private ExpesesAdapter expesesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expesesAdapter = new ExpesesAdapter(this,this);
        binding.recycler.setAdapter(expesesAdapter);
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for(DocumentSnapshot ds:dsList){
                            ...
                            expesesAdapter.add(expenseModel);
                        }
                        setUpGraph();
                    }
                });
